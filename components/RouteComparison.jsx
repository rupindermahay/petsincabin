...
const ROUTES = [
  ...
  },
  {
    ...
    driveCost: [
      "DFDS ferry passage — foot passenger or with a car",
  ...
  },
  {
    ...
    driveCost: null,
    driveNA:
      "this route is a flight plus a scheduled overnight ferry — there is no self-drive leg, so no car, fuel or Eurotunnel ticket to budget",
    driveTotal: null,
    taxiCost: [
      "Pet-friendly cabin (4-berth, sea view, up to 2 dogs) — roughly £150–£210 one way",
