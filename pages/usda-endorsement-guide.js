        ...
        <main className="max-w-4xl mx-auto px-6 py-8 md:py-12">
          ...
          <section className="mb-14 scroll-mt-24">
            ...
            <div className="bg-stone-100 border border-stone-300 p-5 mt-6 mb-2 rounded-sm">
              ...
              <p className="font-serif text-stone-700 leading-relaxed mb-3">
                A qualified EU vet can issue an <strong>EU Pet Passport</strong> on the spot to a pet whose rabies, microchip and tapeworm records check out. An EU Pet Passport is one of the documents Le Shuttle accepts at pet reception. Expect a fee in the €80–150 range (we paid €90 in July 2026). Pet taxi operators who regularly route to the UK often work with a partner vet who can do this same-day — it's a well-known backup for transatlantic pet moves that arrive in France with paperwork endorsed only for EU entry.
              </p>
              <p className="font-serif text-stone-700 leading-relaxed mb-3">
                <strong>Know which direction this works in, because it changed in April 2026.</strong> Great Britain's <em>entry</em> rules did not change: an EU pet passport is still accepted for bringing a pet into GB, which is why this backup still saves a Calais crossing. What changed is the <em>outbound</em> direction — from 22 April 2026, EU pet passports may only be issued to and used by owners whose main residence is in the EU, so a GB resident cannot use one to take a pet from Great Britain into the EU, even a passport issued before that date. GB residents need an Animal Health Certificate for each outbound trip instead.
              </p>
              <p className="font-serif text-stone-700 leading-relaxed mb-3">
                The practical read for a one-way move from the US: the passport can still get you across into the UK. But once you are living in Great Britain, don't assume the same document will take you back out to the EU on a later trip — it won't, and a French vet should no longer be issuing one to you at that point either. Whether a vet will issue a passport to an owner who is mid-move and not yet resident anywhere is a judgement call made at the practice, so don't build your plan on it.
              </p>
              <p className="font-serif text-stone-700 leading-relaxed">
