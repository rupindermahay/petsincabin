      ...
      >
        ...
        <main className="max-w-2xl mx-auto px-6 py-16 md:py-24">
          ...
          <section id="into" className="mb-14 scroll-mt-24">
            ...
            <p className="font-serif text-stone-700 leading-relaxed mb-4">
              The core document is the State Veterinary import permit, issued by South Africa's veterinary authority. It costs <strong>R230</strong> per permit under the tariff that took effect on 1 April 2024, and no application is processed without proof of payment — DALRRD revises these tariffs periodically and publishes them in the Government Gazette, so confirm the current figure when you apply. Once the national office has approved the importation, DALRRD gives three to five working days to process and issue the permit; apply at least four weeks ahead, because that clock only starts after approval. The permit names your port of entry, and changing it later can mean delays or a permit amendment. The permit comes with a veterinary health certificate that your private vet completes — typically within 10 days of the flight — and that the exporting country's government veterinarian must endorse (a <Link href="/usda-endorsement-guide" className="text-amber-700 underline decoration-amber-300">USDA endorsement</Link> for pets from the US). The original is presented to the State Veterinarian who inspects your pet at the port of entry.
            </p>
          ...
          <section id="dogs" className="mb-14 scroll-mt-24">
            ...
            <p className="font-serif text-stone-700 leading-relaxed mb-4">
              Since 1 April 2024, dogs entering South Africa need an <strong>Animal Improvement Compliance Permit</strong> in addition to the standard State Veterinary import permit. It comes from a DALRRD directive of 13 March 2024 requiring every veterinary import permit application to be accompanied by confirmation of compliance with the Animal Improvement Act (No. 62 of 1998) — and DALRRD stated explicitly that this applies to dogs, not only to production animals. It's issued by the Registrar of Animal Improvement, costs <strong>R460</strong>, and the standard turnaround is around 30 working days — so it has to be applied for <em>before</em> the main import permit application, which must be submitted with it attached. DALRRD has undertaken to fast-track urgent applications when they're flagged, so the 30 days is the planning assumption rather than a hard floor. One permit can cover more than one dog — you don't need one per dog. Without it, dogs are denied entry. There is documentation to supply on the dog's breed, and conditions including spay/neuter status. Cats are not affected by this permit — their process is the simpler one.
            </p>

            <p className="font-serif text-stone-700 leading-relaxed">
              Dogs also face a disease-test panel that cats don't: within 30 days of export, dogs must test negative for <em>Brucella canis</em>, <em>Trypanosoma evansi</em>, <em>Babesia gibsoni</em>, <em>Dirofilaria immitis</em> and <em>Leishmania</em>. The 30-day window and the prescribed test methods are exact — any deviation needs a dispensation issued by South Africa in advance (R390). One practical trap: <em>T. evansi</em> can't go to the same lab as the rest. It must be tested at an OIE Reference Laboratory approved for that disease, which for many origin countries means shipping samples abroad — the test isn't available in Canada at all, for instance. Every laboratory report must carry the pet's microchip number.
            </p>

            <div className="bg-amber-50 border-l-2 border-amber-400 p-4 mb-4">
              <p className="font-serif text-stone-700 leading-relaxed text-sm">
                <strong>Non-compliant results are not a quarantine problem — they're a refusal problem.</strong> South Africa has told USDA APHIS that a dog arriving with test results that don't comply "stands a very high chance of being returned to the country of origin or euthanized", and that non-compliant animals will not be taken into quarantine as they were in the past. Assume there is no holding pen for paperwork errors. This is the single strongest argument for using an agent and for getting a dispensation in writing before you fly if anything about your testing is non-standard.
              </p>
            </div>

            <p className="font-serif text-stone-700 leading-relaxed">
              There are also <strong>treatments</strong>, not just tests, and they're easy to miss. A heartworm preventative must be given after the negative <em>Dirofilaria</em> result comes back and before your vet signs the health certificate. Separately, the dog must be treated with an acaricide and an insect repellent — products registered in South Africa — within 30 days of departure, with the dates, product names and dosages recorded on the certificate before it goes for government endorsement. Snub-nosed and strong-jawed breeds may also face airline-level restrictions on the cargo leg. Build the dog requirements into your timeline first, because they're the long pole.
            </p>
          </section>
          ...
          <p className="font-sans text-xs text-stone-400 leading-relaxed mt-12 text-center">
            Verified against DALRRD's own veterinary import permit tariff (effective 1 April 2024), DALRRD's Animal Improvement Act directive of 13 March 2024, USDA APHIS export guidance for South Africa, and South African pet-relocation specialists as of July 2026. Because international pet travel to and from South Africa is cargo-only, exact crate specs, booking processes, timings and costs vary by airline and route — and permit requirements (including the Animal Improvement permit for dogs) change. Always confirm the latest specifics with the State Veterinary authority, the airline's cargo division, or a professional relocation agent before travel.
          </p>
