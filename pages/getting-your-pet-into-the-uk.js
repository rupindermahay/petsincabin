        ...
        <main className="max-w-4xl mx-auto px-6 py-8 md:py-12">
          ...
          <section id="via-paris" className="mb-14 scroll-mt-24">
            ...
            <div className="bg-amber-50 border-2 border-amber-500 p-5 mb-6 rounded-sm">
              ...
              <p className="font-serif text-stone-700 leading-relaxed mb-3">
                If you do land in France with only the EU AHC, the fix is an <strong>EU Pet Passport</strong> issued on the spot by a French vet — typically €80–150 (we paid €90 in July 2026), same-day, accepted at Le Shuttle. Many door-to-door pet taxi operators arrange this through a partner vet — see the pet taxi section below.
              </p>
              <p className="font-serif text-stone-700 leading-relaxed mb-3">
                <strong>One direction only, since 22 April 2026.</strong> Bringing a pet <em>into</em> Great Britain is unchanged — an EU pet passport is still an accepted entry document, which is what makes this backup work. Going the other way is not: EU pet passports may now only be issued to and used by owners whose main home is in the EU, so once you are resident in Great Britain you cannot use one to travel to the EU — including a passport issued to you before the change. For outbound trips you'll need an Animal Health Certificate each time, or you can use the AHC you left the UK on for the return leg within six months of issue.
              </p>
          ...
          <section id="paperwork" className="mb-14 scroll-mt-24">
            ...
            <ul className="font-serif text-stone-700 leading-relaxed mb-4 space-y-2 ml-5 list-disc">
              ...
              <li><strong>An accepted travel document for Great Britain</strong> — an Animal Health Certificate, or an EU pet passport. GB entry rules were not touched by the April 2026 change, so an EU pet passport is still accepted coming <em>into</em> Great Britain (a pre-2021 GB-issued pet passport also still works). If you left the UK on an AHC, that same certificate covers your return for up to six months from its issue date, so you don't need a second document to come home.</li>
